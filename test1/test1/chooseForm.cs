    ...
    public partial class chooseForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                sql = "select * from sc,sctime,class where class.claid = sc.claid and class.claid = sctime.claid and sctime.sctime = '" + time + "' and sc.stuid ='" + stuid + "'";
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection(loginForm.connectionString);
            conn.Open();
            string sql = "select claid as 课程id,claname as 课程,teacher as 任课老师 from class where term='" + term + "'";
            SqlDataAdapter adp1 = new SqlDataAdapter(sql, conn);
            DataSet ds = new DataSet();
            adp1.Fill(ds);
            //载入基本信息
        ...
        private void button4_Click(object sender, EventArgs e)
        {
             ...
             conn.Open();
             string stuxuehao = textBox1.Text;
             string sql3 = "select stuid from student where stuxuehao = '" + stuxuehao + "'";
             SqlCommand cmd2 = new SqlCommand(sql3, conn);
             String id2 = cmd2.ExecuteScalar().ToString();
             int stuid = 0;
             int.TryParse(id2, out stuid);


             string sql = "select claid from class,sctime where claname = '"+claname+"'";
             SqlCommand cmd = new SqlCommand(sql, conn);
             String id1 = cmd.ExecuteScalar().ToString();
             int claid = 0;
             int.TryParse(id1, out claid);
             Convert.ToString(stuid);
             string sql1 = "delete from  sc  where  claid = " + claid + " and stuid = " + stuid;
             //cmd.CommandText = sql;
             ...
             { 
                 ...
                 string sql2 = "select class.claname  from sc,class where sc.claid = class.claid and stuid=" + stuid + "";
